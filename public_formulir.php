...
<html lang="en">
    ...
    <head>
        ...
        <title>FORMULIR TRACER | TRACER AMA YOGYAKARTA</title>
    ...
    <body onload="tampilkanwaktu();
        ...
        <div id="wrapper">
            ...
            <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
                ...
                $nim = $_GET['nim'];
                $key = $_GET['key'];
                mysqli_query($mysqli, "UPDATE alumni SET nikey='$key' WHERE nim='$nim'");
                ...
                if ($count_kuisioner == 0) {
                    ...
                    mysqli_query($mysqli, "INSERT INTO kuisioner(nim,nikey,created_at) VALUES('$nim','$key', '$created_at')");
                }else{
                    $created_at = date('Y-m-d h:i:s');
                    $result = mysqli_query($mysqli, "UPDATE kuisioner SET nikey='$key', created_at='$created_at' WHERE nim='$nim'");

                }
                $result = mysqli_query($mysqli, "SELECT * FROM  alumni a, programstudi p WHERE a.prodi_id=p.id AND a.nikey='$key' AND a.nim='$nim'");
