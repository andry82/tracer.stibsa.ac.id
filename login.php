...
<html lang="en">
    <head>
        ...
        <title>LOGIN | SISTEM INFORMASI TRACER STUDY - SEKOLAH TINGGI ILMU BISNIS KUMALA NUSA</title>
        <!-- Bootstrap Core CSS -->
                ...
                <div class="col-md-4 col-md-offset-4">                    
                    <div class="login-panel panel">
                        <center>
                            ...
                            <br/><b>SISTEM INFORMASI TRACER STUDY<br/>SEKOLAH TINGGI ILMU BISNIS KUMALA NUSA</b><br />
                        </center>
                            ...
                            <form method="post" action="proses_login.php">
                                <fieldset>
                                    <div class="form-group input-group">
                                        ...
                                        <input class="form-control" placeholder="NIM / NIA" name="nimnia" type="text" autofocus>
                                    </div>
                                    <div class="form-group input-group">
