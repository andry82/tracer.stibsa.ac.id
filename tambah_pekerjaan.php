...
<html lang="en">
    ...
    <head>
        ...
        <title>TAMBAH PEKERJAAN | SISTEM INFORMASI TRACER STUDY - SEKOLAH TINGGI ILMU BISNIS KUMALA NUSA</title>
    ...
    <body onload="tampilkanwaktu();
        ...
        <div id="wrapper">
            ...
            <div id="page-wrapper">
                <div class="row">
                    <div class="col-lg-12">
                        <h4 class="page-header"><i class="fa fa-plus fa-fw"></i> TAMBAH PEKERJAAN</h4>
                    </div>
                    <!-- /.col-lg-12 -->
                </div>
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        $alphaLength = strlen($nomor) - 1; //put the length -1 in cache
                        for ($i = 0; $i < 8; $i++) {
                        ...
                        ?>
                        <form method="post" action="simpan_pekerjaan.php"  class="col-lg-6">
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" name="jenis_perusahaan">
                                    ...
                                    while ($data_perusahaan = mysqli_fetch_array($jenis_perusahaan)) {
                                        ?>
                                        <option value="<?php echo $data_perusahaan['id']; ?>"><?php echo strtoupper($data_perusahaan['nama']); ?></option>
                                    <?php } ?>
                                </select>
                            </div>
                            <table>
