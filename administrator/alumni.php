...
<html lang="en">
    ...
    <head>
        ...
        <title>DATA ALUMNI | SISTEM INFORMASI TRACER STUDY - SEKOLAH TINGGI ILMU BISNIS KUMALA NUSA</title>
                ...
                <div class="row">                    
                    <div class="col-lg-12">
                        <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                            ...
                            <tbody>
                                <?php
                                $result = mysqli_query($mysqli, "SELECT * FROM  alumni ORDER BY thn_masuk, nama_mhs ASC");
                                $no = 1;
                                while ($data = mysqli_fetch_array($result)) {
                                    ...
                                    <tr>
                                        ...
                                        <td style="text-align: center">
                                            ...
                                            <a href="detail_alumni.php?nim=<?php echo $nim; ?>" class="btn btn-primary btn-xs"><i class="fa fa-eye fa-fw"></i> DETAIL</a>
                                            <a href="<?php echo $base_url; ?>/public_formulir.php?nim=<?php echo $nim; ?>&key=<?php echo $nikey; ?>" target="_blank" class="btn btn-primary btn-xs"><i class="fa fa-book fa-fw"></i> KUISIONER</a>
                                        </td>
                                    </tr>
                                    <?php
                                }
